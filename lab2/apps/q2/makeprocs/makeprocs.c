...
void main (int argc, char *argv[])
{
  ...
  for(i = 0; i<numprocs; i++) {
    process_create("consumer.dlx.obj", h_mem_str, s_procs_completed_str, lock_str, NULL);
    process_create("producer.dlx.obj", h_mem_str, s_procs_completed_str, lock_str, NULL);
