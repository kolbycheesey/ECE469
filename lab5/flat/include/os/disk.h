...
//#define DISK_FILENAME "/tmp/ee469g76767676.img"		//testing a theory		//theory was correct someone else was using our .img file so this is the one that we might have to use
#define DISK_FILENAME "/tmp/ee469g76.img"
